<template>
  <v-container>
    <v-row>
      <v-col>
        <h1 class="text-h3">Pulseras</h1>
      </v-col>
      <v-col class="text-right">
        <v-btn color="success" @click="openNew()">Nueva Pulsera</v-btn>
      </v-col>
    </v-row>
    <v-row>
      <v-col>
...
<script lang="ts">
import Vue from 'vue'
import {Pulsera, _Pulsera} from "@/models/Pulsera";
import {CatalogoService} from "@/services/CatalogoService";
import FormCreate from "@/components/Catalogos/FormPulseraCreate.vue";
...
export default Vue.extend({
  ...
  data: () => ({
    dialog: false,
    service: new CatalogoService('pulseras'),
    list: [] as _Pulsera[],
    element: new Pulsera(),
    search: '',
    headers: [
      {text: 'Id', value: 'id', align: 'left', width: 150},
      {text: 'Fecha', value: 'fecha_registro', align: 'left', width: 150},
      {text: 'Lote', value: 'lote', align: 'left', width: 150},
      {text: 'Folio Inicial', value: 'folio_inicial', align: 'left'},
      {text: 'Folio Final', value: 'folio_final', align: 'left'},
      {text: 'Total', value: 'total', align: 'left', width: 150},
      {text: 'Disponibles', value: 'disponibles', align: 'left', width: 150},
      {text: 'Asignadas', value: 'asignadas', align: 'left', width: 150},
