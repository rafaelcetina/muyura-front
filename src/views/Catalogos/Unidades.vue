<template>
  <v-container>
    <v-row>
      <v-col>
        <h1 class="text-h3">Unidades</h1>
      </v-col>
      <v-col class="text-right">
        <v-btn color="success" @click="openNew()">Nueva Unidad</v-btn>
      </v-col>
    </v-row>
    <v-row>
      <v-col>
...
export default Vue.extend({
  ...
  data: () => ({
    ...
    headers: [
      ...
      {text: 'Clave', value: 'unidad_clave', align: 'left', width: 200},
      {text: 'Nombre', value: 'unidad_nombre', align: 'left'},
