  ...
  <v-container>
    <v-row>
      ...
      <v-col class="text-right">
        <v-btn color="success" @click="openNew()">Nuevo Entregable</v-btn>
      </v-col>
    </v-row>
    <v-row>
      <v-col>
...
<script lang="ts">
import Vue from 'vue'
import {Entregable, _Entregable} from "@/models/Entregable";
import {CatalogoService} from "@/services/CatalogoService";
import FormCreate from '@/components/Catalogos/FormEntregableCreate.vue'
...
export default Vue.extend({
  ...
  data: () => ({
    dialog: false,
    service: new CatalogoService('entregables'),
    list: [] as _Entregable[],
    element: new Entregable(),
    search: '',
    headers: [
