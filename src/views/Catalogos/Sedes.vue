<template>
  <v-container>
    <v-row>
      <v-col>
        <h1 class="text-h3">Sedes</h1>
      </v-col>
      <v-col class="text-right">
        <v-btn color="success" @click="openNew()">Nueva Sede</v-btn>
      </v-col>
    </v-row>
    <v-row>
      <v-col>
...
<script lang="ts">
import Vue from 'vue'
import {Sede, _Sede} from "@/models/Sede";
import {CatalogoService} from "@/services/CatalogoService";
import FormCreate from "@/components/Catalogos/FormSedeCreate.vue";
...
export default Vue.extend({
  ...
  data: () => ({
    dialog: false,
    service: new CatalogoService('sedes'),
    list: [] as _Sede[],
    element: new Sede(),
    search: '',
    headers: [
      ...
      {text: 'Región', value: 'region.nombre', align: 'left'},
      {text: 'Dirección', value: 'direccion', align: 'left'},
      {text: 'Fechas', value: 'fecha_apertura', align: 'left'},
